...
# declare figure #     
p1 = figure(toolbar_location=None,output_backend="canvas", plot_height=1000, plot_width=1000)
p1.xaxis.major_label_orientation = np.pi/4
# p2 = figure(toolbar_location=None)
# p2.xaxis.major_label_orientation = np.pi/4
# p3 = figure(toolbar_location=None,output_backend="canvas")
...
def cir_callback():
    ...
    if end_i<len(input_data['Date']):
        ...
        # print (int(input_data['Date'][start_i])/10000)
